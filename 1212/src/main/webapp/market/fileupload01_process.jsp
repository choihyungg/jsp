...
1) MultipartRequest 클래스를 사용하도록 page 디렉티브 태그의 import 속성 값에 패키지 com.oreilly.servlet.*을 작성.
2) DefaultFileRenamePolicy 클래스를 사용하도록 page 디렉티브 태그의 import 속성 값에 패키지 com.oreilly.servlet.*을 작성.
...
<%
	...
	getContentType() : 폼 페이지에서 전송된 파일의 컨텐츠 유형을 반환.
